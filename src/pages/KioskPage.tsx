      ...
      <main className="kioskA-grid">
        ...
        <section className="kioskA-panel">
          ...
          <p className="kioskA-lead">
            Vi är stolta över att presentera vår helt nyöppnade kiosk – fullproppad med godsaker som gör
            bioupplevelsen ännu bättre. Här hittar du allt från klassiska popcorn och läsk till färgstarka
            snacks och sötsaker i sann retro-anda. Perfekt för dig som vill krydda filmkvällen med något extra!
          </p>

          <div className="kioskA-cols">
            <p>
              Hos oss hittar du både klassiker och nya favoriter – popcorn, läsk, godis och snacks som
              förhöjer filmupplevelsen.
            </p>
            <p>
              På Neon Snacks hittar du inte bara godis och popcorn – vi serverar även enklare mat som korv med
              bröd och andra snabba rätter. Perfekt om du vill stilla hungern innan filmen börjar!
            </p>
          </div>
